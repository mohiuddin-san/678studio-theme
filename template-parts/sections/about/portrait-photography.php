...
<section class="portrait-photography">
  <div class="portrait-photography__container">
    ...
    <div class="portrait-photography__grid">
      ...
      <div class="portrait-photography__item portrait-photography__item--1">
      ...
      <div class="portrait-photography__item portrait-photography__item--2">
      </div>

      <!-- Grid Item 3 - Image (right side) -->
      <div class="portrait-photography__item portrait-photography__item--3">
