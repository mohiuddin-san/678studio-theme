      ...
      <div class="hero-section__cta">
        <a href="<?php echo home_url('/stores'); ?>" class="hero-section__cta-button">
          ...
          <img src="<?php echo get_template_directory_uri(); ?>/assets/images/search.svg" 
               alt="検索" class="hero-section__cta-icon">
        </a>
      </div>
    </div>
  </div>
  ...
  <div class="hero-section__sp">
    <div class="hero-section__sp-container">
      ...
      <div class="hero-section__sp-bg">
        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/hero_bg_sp.jpg" 
             alt="写真館背景">
      </div>
      ...
      <div class="hero-section__sp-content">
        ...
        <!-- CTA Button -->
        <div class="hero-section__sp-cta">
          <a href="<?php echo home_url('/stores'); ?>" class="hero-section__sp-cta-button">
            写真館を探す
            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/search.svg" 
                 alt="検索" class="hero-section__sp-cta-icon">
          </a>
        </div>
      </div>
    </div>
