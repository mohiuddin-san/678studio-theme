...
<main class="main-content button-test-page">
  <div style="padding: 40px 0; min-height: 100vh;">
    <div style="max-width: 1200px; margin: 0 auto; padding: 0 20px;">
      ...
      <div style="background: #f8f9fa; padding: 30px; border-radius: 12px; border: 1px solid #e9ecef;">
        ...
        <pre style="background: #fff; padding: 20px; border-radius: 8px; overflow-x: auto; font-size: 14px; line-height: 1.5;"><code>&lt;?php get_template_part('template-parts/components/camera-button', null, [
  'text' => 'ボタンテキスト',
  'url' => '#',
  ...
  'icon' => 'cam' // cam, people, mailsend, home, none
      ...
      <div style="text-align: center; margin-top: 40px;">
        <a href="<?php echo home_url(); ?>" style="display: inline-block; padding: 12px 24px; background: #007cba; color: white; text-decoration: none; border-radius: 6px;">トップページに戻る</a>
      </div>
