/**
 * Certified Stores Load More Functionality
 * SP版の認定店舗カードのロードモア機能
 */

document.addEventListener('DOMContentLoaded', function() {
    const loadMoreBtn = document.querySelector('.certified-stores-list-sp__load-more-btn');
    ...
    loadMoreBtn.addEventListener('click', function() {
        // 次の5枚のカードを表示
        const cardsToShow = 5;
        const cards = document.querySelectorAll('.certified-store-card-sp');
